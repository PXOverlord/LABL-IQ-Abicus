  ...
  return (
    <div className="relative shrink-0 size-4">
      ...
      >
        ...
        />
        <path
          d="M10 8C13.3137 8 16 10.6863 16 14V16C16 17.1046 15.1046 18 14 18H6C4.89543 18 4 17.1046 4 16V14C4 10.6863 6.68629 8 10 8Z"
          fill="currentColor"
        />
      </svg>
    </div>
