...
CREATE TABLE "users" (
    ...
    "defaultSurcharge" DOUBLE PRECISION DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE "column_profiles" ADD CONSTRAINT "column_profiles_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
